...
// In this exercise I didn't quite understand why it worked, when I created the function only met one requirement, bu after refactoring it, it worked for some reason.
...
function tallyUpDonations(runners) {
  return runners.reduce((a, b) => (a = a + b.donation), 0);
}
